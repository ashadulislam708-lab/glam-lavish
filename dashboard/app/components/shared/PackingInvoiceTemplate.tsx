      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0, wordBreak: "break-word", paddingRight: "3mm" }}>
          ...
          <div style={{ fontSize: "12px", marginBottom: "1px", wordBreak: "break-word" }}>
            <svg xmlns="http://www.w3.org/2000/svg" width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ display: "inline", verticalAlign: "baseline", marginRight: "3px" }}><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
          ...
          <div style={{ fontSize: "12px", lineHeight: 1.4, wordBreak: "break-word", overflowWrap: "break-word" }}>
            <svg xmlns="http://www.w3.org/2000/svg" width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ display: "inline", verticalAlign: "baseline", marginRight: "3px" }}><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
